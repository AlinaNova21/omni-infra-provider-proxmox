...
import (
	...
	"github.com/alinanova21/omni-infra-provider-proxmox/api/specs"
	providermeta "github.com/alinanova21/omni-infra-provider-proxmox/internal/pkg/provider/meta"
)
